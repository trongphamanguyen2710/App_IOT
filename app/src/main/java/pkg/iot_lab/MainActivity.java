...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtHumi = findViewById(R.id.txtHumid);
        ...
        btn2.setOnToggledListener(new OnToggledListener() {
            ...
            public void onSwitched(ToggleableView toggleableView, boolean isOn) {
                if (isOn) {
                    mqttHelper.publishData("batrong0610/feeds/nutnhan2", "1");
                } else {
                    mqttHelper.publishData("batrong0610/feeds/nutnhan2", "0");
                }
            }
        });
        ...
        txtHumi.setOnClickListener(humidityClickListener);
        findViewById(R.id.img_humidity).setOnClickListener(humidityClickListener);

        txtLight.setOnClickListener(lightClickListener);
        findViewById(R.id.img_light).setOnClickListener(lightClickListener);
